                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('products.update', $product->id) }}" method="POST"
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <textarea rows="3" name="description_ru" class="form-control" value="">{{ $product->description_ru }}</textarea>
                                        </div>
                                        <div class="col">
                                            <label>Описание на узбекском</label>
                                            <textarea rows="3" name="description_uz" class="form-control" value="">{{ $product->description_uz }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-control" style="width: 100%;" name="category_id" value=""
                                        ...
                                        @foreach ($categories as $category)
                                            <option {{ $category->id === $product->category->id ? 'selected' : '' }}
                                                value="{{ $category->id }}">{{ $category->emoji }}
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" name="sale" {{ $product->isSale ? 'checked' : '' }}
                                        id="sale">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group" id="photo">
                                    ...
                                    <img class="img img-thumbnail" src="{{ $product->getImage() }}" alt=""
                                        width="100">
