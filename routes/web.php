...
Route::post('wishes/{product}', [WishController::class, 'store'])->name('wishes.store')->middleware('admin');
Route::post('cards/{product}', [CardController::class, 'store'])->name('cards.store')->middleware('admin');